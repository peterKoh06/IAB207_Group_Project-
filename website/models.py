...
class Event(db.Model):
    ...
    id = db.Column(db.String(6), primary_key=True)
    host_id = db.Column(db.String(6), db.ForeignKey('Users.id'), nullable=False)
...
class EventOffering(db.Model):
    ...
    event_id = db.Column(db.String(6), db.ForeignKey('Events.id'), primary_key=True)
    offering_id = db.Column(db.String(6), db.ForeignKey('Offerings.id'), primary_key=True)
